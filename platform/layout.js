...
export function findMonitorForActor(actor) {
    return Main.layoutManager.findIndexForActor(actor);
}
export function isOverviewVisible() {
    return Main.overview.visible;
}
export function isOverviewAnimating() {
    return Main.overview.animationInProgress;
}
...
export function getScreenWidth() {
    return global.stage.width;
}
export function getScreenHeight() {
    return global.stage.height;
}
